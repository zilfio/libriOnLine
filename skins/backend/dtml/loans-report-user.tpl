				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<td>I prestiti di color arancio sono stati restituiti ma in
								ritardo rispetto alla presunta data di restituzione.</td>
						</tr>
						<tr>
							<td style="background-color: #dd4b39"></td>
							<td>I prestiti di color rosso sono scaduti e non sono ancora
								stati restituiti..</td>
						</tr>
						<tr>
							<td style="background-color: #1D599C"></td>
							<td>I prestiti di color blu sono regolarmente in corso di
								prestito.</td>
						</tr>
					</table>
				</div>
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Report Prestiti</div>
			<!-- /.panel-heading -->
			<div class="panel-body">
				<div class="table-responsive">
					<table
						...
						<tr>
							...
							<td>{if $loan->getDataRestituzione() eq NULL} / {else}
								{$loan->getDataRestituzione()|date_format:"%d/%m/%Y"} {/if}</td>
